...
<body class="product_details">
	...
	<div class="main inner clearfix">
		<div class="path"><span> GLORY ATX 7SE</span> > <span>ATX 777</span></div>
		<div class="picList">
			<ul class="pic">
				<li><img src="/home/images/product/7.jpg"/></li>
				<li class="hide"><img src="/home/images/product/7.jpg"/></li>
				<li class="hide"><img src="/home/images/product/7.jpg"/></li>
			</ul>
		</div>
		<div class="productText">
			<h3>ATX 7771</h3>
			<p class="sale">11.11当天每满600减30,可跨店</p>
			<p>Giant捷安特ATX777山地自行车27速油压碟刹油簧可锁死避震前叉 ATX</p>
			<div class="priceBox"><span class="tags">售价</span><span class="price">￥2798.00</span></div>
			<div>
				<p class="tags">服务说明</p>
				<p class="con">满100元免运费</p>
			</div>
			<div>
				<p class="tags">速别</p>     
				<ul class="con">
					<li class="active">21速</li>
				</ul>
			</div>
			<div>
				<p class="tags">颜色</p>     
				<ul class="con">
					<li>亮白165-175cm</li>
					<li class="active">亮黄165-175cm</li>
					<li>亮白165-175cm 拷贝</li>
				</ul class="con">
			</div>
			<div>
				<p class="tags">轮径尺寸</p>     
				<ul class="con">
					<li class="active">26英寸</li>
				</ul>
			</div>
			<div>
				<p class="tags">提货方式</p>     
				<ul class="con">
					<li class="active">电子兑换券</li>
				</ul>
			</div>
			<div>
				<p class="tags">有效期</p>     
				<p class="con">购买成功30天内有效</p>
			</div>
			<div>
				<p class="tags">数量</p>
				<div class="num con">
			...
			<input type="submit" name="" id="" value="立即购买" class="clickBtn"/>
			<input type="submit" name="" id="" value="加入购物车"  class="clickBtn buy"/>
		</div>
	</div>
	<div class="inner">
		<h3>商品详情</h3>
		<div id="">
			<img src="/Home/images/product/8.jpg"/>
			<img src="/Home/images/product/9.jpg"/>
		</div>
	</div>
