        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
                ...
                <div id="sidebar-scroll">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="/Admin/index">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                ...
                                <li class="nav-main-heading"><span class="sidebar-mini-hide">后台</span></li>
                                <li class="@yield('user')">
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-users"></i><span class="sidebar-mini-hide">用户管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="/Admin/User/index" class="@yield('userList')" >用户列表</a>
                                        </li>
                                        <li>
                                            <a href="/Admin/User/add" class="@yield('userAdd')">添加用户</a>
                                        </li>
                                        <li>
                                            <a href="/Admin/User/recycle" class="@yield('userRecycle')">回收站</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-main-heading"><span class="sidebar-mini-hide">前台核心</span></li>
                                <li class="@yield('type')">
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-grid"></i><span class="sidebar-mini-hide">分类管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="/Admin/Type/index" class="@yield('typeList')" >浏览分区</a>
                                        </li>
                                        <li>
                                            <a href="/Admin/Type/add/0" class="@yield('typeAdd')" >添加分区</a>
                                        </li>
                                        <li>
                                            <a href="">回收站</a>
                                        </li>
                                ...
                                <li class="@yield('goods')">
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-handbag"></i><span class="sidebar-mini-hide">商品管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="/Admin/Goods/index" class="@yield('goodsList')" >商品列表</a>
                                        </li>
                                        <li>
                                            <a href="/Admin/Goods/add" class="@yield('goodsAdd')" >添加商品</a>
                                        </li>
                                        <li>
                                            <a href="">仓库商品</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-paper-clip"></i><span class="sidebar-mini-hide">订单管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="#">订单列表</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-basket"></i><span class="sidebar-mini-hide">购物车管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="#">订单列表</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-link"></i><span class="sidebar-mini-hide">友情链接</span></a>
                                    <ul>
                                        <li>
                                            <a href="">链接列表</a>
                                        </li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-magic-wand"></i><span class="sidebar-mini-hide">广告管理</span></a>
                                    <ul>
                                        <li>
                                            <a href="">400</a>
                                        </li>
            ...
            <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
                <div class="pull-right">
                    Crafted with <i class="fa fa-heart text-city"></i> by <a class="font-w600" href="" target="_blank">YangPan</a>
                </div>
                <div class="pull-left">
                    <a class="font-w600" href="javascript:void(0)" target="_blank">OneUI 1.0</a> &copy; <span>2018-1</span>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
